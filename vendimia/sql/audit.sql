...
--Privilegies to Eduardo  user
GRANT USAGE ON SCHEMA audit TO Eduardo;
ALTER DEFAULT PRIVILEGES IN SCHEMA audit GRANT ALL ON TABLES TO Eduardo;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA audit TO Eduardo;
GRANT ALL ON ALL TABLES IN SCHEMA audit TO Eduardo;